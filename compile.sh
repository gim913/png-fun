...
FILEZ="encoDeco.o wrapLz4.o wrapLzham.o wrapBsc.o utiltime.o lz4-read-only/lz4.o lz4-read-only/lz4hc.o lzham-read-only/cmake/liblzhamlib.a libbsc-0b12f29/libbsc.a"
...
echo g++ -I. -O2 wrapLzham.cpp -c
g++ -I. -O2 wrapBsc.cpp -c
echo g++ -I. -O2 utiltime.cpp -c

g++ -I. -lpthread -O2 lodepng.enc.o $FILEZ -o bin/png2cus
g++ -I. -lpthread -O2 lodepng.dec.o $FILEZ -o bin/cus2png
