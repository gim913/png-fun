...
FILEZ="encoDeco.o wrapLz4.o wrapLzham.o wrapBsc.o wrapDaSh.o utiltime.o"
LIBZ="lz4-read-only/lz4.o lz4-read-only/lz4hc.o lzham-read-only/cmake/liblzhamlib.a libbsc-0b12f29/libbsc.a data-shrinker-read-only/Shrinker.o"
